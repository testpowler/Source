...
if (MsgText[1] == "رفع منشئ اساسي" or MsgText[1] == "رفع منشئ اساسي") then
...
if (MsgText[1] == "تنزيل منشئ اساسي" or MsgText[1] == "تنزيل منشئ اساسي") then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور,المطور الاساسي} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then 
...
if (MsgText[1] == "رفع منشئ" or MsgText[1] == "رفع منشئ") then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور,المطور الاساسي} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then
...
if (MsgText[1] == "تنزيل منشئ" or MsgText[1] == "تنزيل منشئ" ) then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور,المطور الاساسي} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then
...
if NumMnsha ==0 then 
return "♦️┇عذرا لا يوجد منشئ اساسي \n!" 
end
redis:del(max..':Hussain:'..msg.chat_id_)
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."   \n♦️┇ تم مسح {* "..NumMnsha.." *} المنشئ الاساسي \n✓"
end
...
if MsgText[1] == "سورس" or MsgText[1]=="السورس" or MsgText[1]=="يا سورس" then
return [[
📡┇[قناة السورس](t.me/CH_POWLER) [@CH_POWLER]
👨🏻‍✈️┇[مـطـور الـسـورس](t.me/MANIALXBLACK)
👨🏻‍✈️┇[2مـطـور الـسـورس](t.me/DESHAXBLACK)
👨🏻‍✈️┇[3مـطـور الـسـورس](t.me/MESSIXBLACK)
